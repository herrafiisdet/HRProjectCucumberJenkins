...
public class LoginSteps extends CommonMethods {
    ...
    public void user_enters_valid_username_and_valid_password() {
        ...
        //System.out.println(10/0); //this line was added to intentionally failed the test
    ...
    public void user_is_successfully_logged_in() {
        ...
        if (dashboard.welcomeAdminMessage.isDisplayed()){
    ...
    public void user_enters_employee_username_and_employee_password() {
        //LoginPage login = new LoginPage(); //not needed now because we are using PageInitialize.
       // WebElement usernameField = driver.findElement(By.id("txtUsername"));
    ...
    public void error_message_desplayed() {
